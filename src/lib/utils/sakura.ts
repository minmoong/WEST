export const Sakura = function (this: any, element: HTMLDivElement) {
	this.el = element;
	...
	function randomArrayElem(arr: string | any[]) {
	...
	function PrefixedEvent(element: HTMLDivElement, type: string, callback: { (): void; (): void }) {
	...
	function elementInViewport(el: HTMLDivElement) {
